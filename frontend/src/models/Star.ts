...
export default class Star
  extends CelestialBody<StarParameters>
  implements IMeshProvider
{
  ...
  public initialiseBaseMesh = (): void => {
    ...
    this.celestialBodyMaterial.specularMap = this._textures.Specular
      ? this.loader.load(this._textures.Specular)
      : null;
    // this._celestialBodyMaterial.bumpMap =  this._textures.Bump ? this._loader.load(this._textures.Bump) : null
    // this._celestialBodyMaterial.displacementMap = this._textures.Bump ? this._loader.load(this._textures.Bump) : null
    // this._celestialBodyMaterial.bumpScale =  0.04
  ...
  private addLight = () => {
    ...
    this._celestialBodyMaterial.emissiveMap = this.loader.load(
      this._textures.Map
    );
    this._celestialBodyMaterial.emissiveIntensity =
      this._physicalParameters.SurfaceEmission;
